TITLE Caracter minusculo para maiusculo
.MODEL SMALL
.DATA
  ; define as variaveis de mensagem a serem exibidas
  MSG1 DB "Digite uma letra minúscula $"
  MSG2 DB "O caracter maiúsculo é: $"
...
MAIN PROC
  ...
  ;copia o caracter lido para BL e converte para letra maiuscula usando ASCII
       MOV BL,AL
       SUB BL,32
  ...
  ; exibe o caracter lido em maiusculo
       MOV AH,2
       MOV DL,BL
       INT 21h
